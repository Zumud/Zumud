  ...
  const testimonials = [
    {
      ...
      content: "Zumud helped me get my dream job at a tech startup. The AI-powered resume was exactly what I needed to stand out from hundreds of applicants.",
      rating: 5
    },
    {
      name: "Sarah Chen",
      title: "Marketing Manager",
      content: "I was amazed at how quickly I could create a professional resume. Within 2 weeks of using Zumud, I had 3 job interviews lined up!",
      rating: 5
    },
    {
      name: "Michael Rodriguez",  
      title: "Data Analyst",
      content: "The ATS optimization feature is incredible. My resume now gets past automated systems and I'm getting more callbacks than ever before.",
      rating: 5
    }
  ]
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600">
              Join thousands of job seekers who have successfully landed their dream jobs using Zumud.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Zumud. All rights reserved.</p>
          </div>
        </div>
      </footer>
