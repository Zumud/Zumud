...
# Expected output:
# m.mohammadi.cie@gmail.com (Google Drive)
```
...
insync-headless selective-sync --account m.mohammadi.cie@gmail.com --cloud gd
```
...
ls -la /root/Insync-headless/m.mohammadi.cie@gmail.com/Google\ Drive/
