...
class UserTemplateBase(BaseModel):
    name: str = Field(..., min_length=1, max_length=100, description="User-friendly name for the template")
    latex_content: str = Field(..., min_length=1, description="The LaTeX template content")
    compiler: str = Field(default="pdflatex", description="LaTeX compiler to use (pdflatex, xelatex, lualatex)")
